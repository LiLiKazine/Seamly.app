...
/// - **Unified log** (`os.Logger`, subsystem `io.github.lilikazine.Seamly`): real-time,
...
public struct Diagnostics: Sendable {
    ...
    public init(containerURL: URL?, category: Category) {
        ...
        self.logger = Logger(subsystem: "io.github.lilikazine.Seamly", category: category.rawValue)
