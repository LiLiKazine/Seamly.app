...
/// `SeamlyBroadcast` extension. Both targets compile this file.
enum AppGroup {
    /// Must match `com.apple.security.application-groups` in both targets' entitlements.
    static let identifier = "group.io.github.lilikazine.Seamly"
    ...
    /// truth regardless).
    static let sessionFinishedNotification = "io.github.lilikazine.Seamly.sessionFinished"
